                            ...
                            <figure>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="flex flex-row items-center justify-between">
                                        ...
                                        <p>Independently handled end-to-end project delivery from development to deployment including client communication. Increased incomming online traffic by 10% within the first week.</p>
